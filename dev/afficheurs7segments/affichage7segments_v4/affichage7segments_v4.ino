...
void ParseSerialData()
 ...
 for(dataLenght=0; inData[dataLenght] != '\0'; dataLenght++); 
 
 if(lenght==3)
 {
 displayValue[0] = convertAscii2Segment(p[0]);
 displayValue[1] = convertAscii2Segment(p[1]);
 displayValue[2] = convertAscii2Segment(p[2]);
 ...
 {
 displayValue[0] = convertAscii2Segment(' ');
 displayValue[1] = convertAscii2Segment(p[0]);
 displayValue[2] = convertAscii2Segment(p[1]); 
 //Serial.write(p[0]);
 //Serial.write(p[1]);
 //Serial.println();
 }
 ...
 displayValue[0] = convertAscii2Segment(' ');
 displayValue[1] = convertAscii2Segment(' ');
 displayValue[2] = convertAscii2Segment(p[0]); 
 //Serial.write(p[0]);
 //Serial.println();
 }
